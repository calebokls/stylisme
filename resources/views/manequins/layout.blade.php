...
<html
  ...
  <head>
    ...
    <title>@yield('title')|Manequina</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">MANEQUINA</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Dashboards">Manequina</div>
                <div class="badge bg-danger rounded-pill ms-auto">5</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a
                    href="{{route('manequina.manequin.index')}}"
                    class="menu-link">
                    <div data-i18n="CRM">Vos media</div>
                    <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div>
                  </a>
                </li>
                <li class="menu-item active">
                  <a href="{{route('manequina.manequin.create')}}" class="menu-link">
                    <div data-i18n="Analytics">Nouveau Media</div>
                  </a>
                </li>
