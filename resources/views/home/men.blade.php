                 ...
                 <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="{{route('style.modely.show',['modely'=>$women])}}" class="quick-view-button block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 " id="{{$women->id}}">
								Quick View
							</a>
						</div>
					...
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div id="slackjs" class="slick3 gallery-lb">
